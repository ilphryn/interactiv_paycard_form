      ...
      <div class="card-item__wrapper">
        ...
        <div class="card-item__content">
          <label :for="fields.cardName" class="card-item__info" :ref="fields.cardName">
            <div class="card-item__holder">Proprietaire</div>
            <transition name="slide-fade-up">
              ...
              <div class="card-item__name" v-else key="2">Mr MANCHIN</div>
            </transition>
          </label>
          <div class="card-item__date" ref="cardDate">
            <label :for="fields.cardMonth" class="card-item__dateTitle"></label>
