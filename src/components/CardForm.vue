  ...
  <div class="card-form">
    ...
    <div class="card-form__inner">
      <div class="card-input">
        <label for="cardNumber" class="card-input__label">Numéro</label>
        <input
          type="text"
      ...
      <div class="card-input">
        <label for="cardName" class="card-input__label">Identité</label>
        <input
          type="text"
          :id="fields.cardName"
      ...
      <button class="card-form__button">Valider</button>
    </div>
  </div>
</template>
